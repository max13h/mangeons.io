...
interface Table_public_alimentary_products {
  id: string;
  created_at: string;
  name: string;
...
interface Table_public_alimentary_products_shopping_lists {
  id: string;
...
interface Table_public_households {
  id: string;
  name: string;
  created_at: string;
  user_id: string;
}
interface Table_public_households_kitchen_equipments {
  id: string;
  household_id: string;
...
interface Table_public_kitchen_equipments {
  id: string;
  created_at: string;
  name: string;
  name_fr: string | null;
...
interface Table_public_meal_category {
  id: string;
  name: string | null;
  name_fr: string | null;
}
interface Table_public_menus {
  id: string;
  created_at: string;
  name: string;
  user_id: string;
...
interface Table_public_none_alimentary_products {
  id: string;
  created_at: string;
  name: string;
...
interface Table_public_none_alimentary_products_shopping_lists {
  id: string;
...
interface Table_public_recipes {
  id: string;
  created_at: string;
  name: string;
  author: string | null;
...
interface Table_public_recipes_alimentary_products {
  id: string;
  created_at: string;
  recipe_id: string;
  alimentary_product_id: string;
...
interface Table_public_recipes_kitchen_equipments {
  id: string;
  recipe_id: string;
  kitchen_equipment_id: string;
}
interface Table_public_recipes_menus {
  id: string;
  menu_id: string;
  recipe_id: string;
}
...
interface Table_public_shopping_lists {
  id: string;
  created_at: string;
  household_id: string;
  menu_id: string | null;
...
interface Table_public_store_areas {
  id: string;
  name: string;
  name_fr: string | null;
}
...
interface Schema_public {
  alimentary_products: Table_public_alimentary_products;
  alimentary_products_shopping_lists: Table_public_alimentary_products_shopping_lists;
  households: Table_public_households;
  households_kitchen_equipments: Table_public_households_kitchen_equipments;
  kitchen_equipments: Table_public_kitchen_equipments;
  meal_category: Table_public_meal_category;
  menus: Table_public_menus;
  none_alimentary_products: Table_public_none_alimentary_products;
  none_alimentary_products_shopping_lists: Table_public_none_alimentary_products_shopping_lists;
  recipes: Table_public_recipes;
  recipes_alimentary_products: Table_public_recipes_alimentary_products;
  recipes_kitchen_equipments: Table_public_recipes_kitchen_equipments;
  recipes_menus: Table_public_recipes_menus;
  shopping_lists: Table_public_shopping_lists;
  store_areas: Table_public_store_areas;
...
interface Tables_relationships {
  "public.alimentary_products": {
    parent: {
       alimentary_products_store_area_id_fkey: "public.store_areas";
    };
    children: {
       alimentary_products_shopping_lists_alimentary_product_id_fkey: "public.alimentary_products_shopping_lists";
       recipes_alimentary_products_alimentary_product_id_fkey: "public.recipes_alimentary_products";
    };
  };
  "public.alimentary_products_shopping_lists": {
    parent: {
       alimentary_products_shopping_lists_alimentary_product_id_fkey: "public.alimentary_products";
       alimentary_products_shopping_lists_shopping_list_id_fkey: "public.shopping_lists";
    };
    children: {
  ...
  "public.households": {
    ...
    children: {
       households_kitchen_equipments_household_id_fkey: "public.households_kitchen_equipments";
       shopping_lists_household_id_fkey: "public.shopping_lists";
       users_household_id_fkey: "public.users";
    };
  };
  "public.households_kitchen_equipments": {
    parent: {
       households_kitchen_equipments_household_id_fkey: "public.households";
       households_kitchen_equipments_kitchen_equipment_id_fkey: "public.kitchen_equipments";
    };
    children: {
  ...
  "public.kitchen_equipments": {
    parent: {

    };
    children: {
       households_kitchen_equipments_kitchen_equipment_id_fkey: "public.households_kitchen_equipments";
       recipes_kitchen_equipments_kitchen_equipment_id_fkey: "public.recipes_kitchen_equipments";
    };
  };
  "public.meal_category": {
    ...
    children: {
       recipes_meal_category_id_fkey: "public.recipes";
    };
  };
  "public.menus": {
    parent: {
       menus_user_id_fkey: "public.users";
    };
    children: {
       recipes_menus_menu_id_fkey: "public.recipes_menus";
       shopping_lists_menu_id_fkey: "public.shopping_lists";
    };
  };
  "auth.mfa_amr_claims": {
    parent: {
  ...
  "public.none_alimentary_products": {
    parent: {
       none_alimentary_products_store_area_id_fkey: "public.store_areas";
    };
    children: {
       none_alimentary_products_shopping_lists_none_alimentary_product: "public.none_alimentary_products_shopping_lists";
    };
  };
  "public.none_alimentary_products_shopping_lists": {
    parent: {
       none_alimentary_products_shopping_lists_none_alimentary_product: "public.none_alimentary_products";
       none_alimentary_products_shopping_lists_shopping_list_id_fkey: "public.shopping_lists";
    };
    children: {
  ...
  "public.recipes": {
    parent: {
       recipes_meal_category_id_fkey: "public.meal_category";
       recipes_author_fkey: "public.users";
    };
    children: {
       recipes_alimentary_products_recipe_id_fkey: "public.recipes_alimentary_products";
       recipes_kitchen_equipments_recipe_id_fkey: "public.recipes_kitchen_equipments";
       recipes_menus_recipe_id_fkey: "public.recipes_menus";
    };
  };
  "public.recipes_alimentary_products": {
    parent: {
       recipes_alimentary_products_alimentary_product_id_fkey: "public.alimentary_products";
       recipes_alimentary_products_recipe_id_fkey: "public.recipes";
    };
    children: {

    };
  };
  "public.recipes_kitchen_equipments": {
    parent: {
       recipes_kitchen_equipments_kitchen_equipment_id_fkey: "public.kitchen_equipments";
       recipes_kitchen_equipments_recipe_id_fkey: "public.recipes";
    };
    children: {

    };
  };
  "public.recipes_menus": {
    parent: {
       recipes_menus_menu_id_fkey: "public.menus";
       recipes_menus_recipe_id_fkey: "public.recipes";
    };
    children: {
  ...
  "public.shopping_lists": {
    parent: {
       shopping_lists_household_id_fkey: "public.households";
       shopping_lists_menu_id_fkey: "public.menus";
    };
    children: {
       alimentary_products_shopping_lists_shopping_list_id_fkey: "public.alimentary_products_shopping_lists";
       none_alimentary_products_shopping_lists_shopping_list_id_fkey: "public.none_alimentary_products_shopping_lists";
    };
  };
  "auth.sso_domains": {
    parent: {
  ...
  "public.store_areas": {
    ...
    children: {
       alimentary_products_store_area_id_fkey: "public.alimentary_products";
       none_alimentary_products_store_area_id_fkey: "public.none_alimentary_products";
    };
  };
  "auth.users": {
    parent: {
    ...
    children: {
       ...
       users_user_id_fkey: "public.users";
    };
  };
  "public.users": {
    parent: {
       users_user_id_fkey: "auth.users";
       users_household_id_fkey: "public.households";
    };
    children: {
       households_user_id_fkey: "public.households";
       menus_user_id_fkey: "public.menus";
       recipes_author_fkey: "public.recipes";
    };
  };
}
//#endregion
