<template>
  <div>
    ...
    <Teleport v-if="modalStore.whatIsOpen == 'addAlimentaryProducts'" to="#modal">
      <RecipeFormAddAlimentaryProducts></RecipeFormAddAlimentaryProducts>
    </Teleport>
    <div class="min-h-[300px] bg-white border-dashed border-2 border-secondary w-full rounded-xl p-4 overflow-y-scroll mb-7 relative">
      ...
      <RecipeFormAddAlimentaryProductsShowCard v-for="alimentaryProduct in recipeStore.selectedAlimentaryProducts" v-else :key="alimentaryProduct.details.id" :alimentary-product="alimentaryProduct.details"></RecipeFormAddAlimentaryProductsShowCard>
    </div>
