<template>
  <div class="flex flex-col items-center h-full">
    ...
    <div v-if="recipe && recipe.name" class="flex-grow pt-4 pl-4 pr-4 overflow-y-scroll overflow-x-hidden">
      ...
      >
        <RecipeFormNameDescriptionAndCategory v-if="pageNb === 1" :name="recipe.name" :description="recipe.description" :category="recipe.meal_category_id" />
      </Transition>
      <Transition
        enter-active-class="transition duration-100 ease-out"
      ...
      >
        <RecipeFormCookingTimeAndKitchenEquipments v-if="pageNb === 2" :cooking-time="recipe.cooking_time" />
      </Transition>
      <Transition
        enter-active-class="transition duration-100 ease-out"
        :enter-from-class="goToNext ? 'translate-x-full' : '-translate-x-full'"
      ...
      <Transition
        ...
        leave-to-class="translate-x-full"
      >
        <RecipeFormContent v-if="pageNb === 4" :content="recipe.content"></RecipeFormContent>
      </Transition>
    </div>
